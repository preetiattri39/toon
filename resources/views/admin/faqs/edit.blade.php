        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="add-faq" method="post" action="{{route('update-faq')}}">
                        @csrf
                        <input type="hidden" name="faq_id" id="faq_id" value="{{$faq->id}}">
                        <div class="form-group">
                            <label for="question">Question</label>
                            <input type="text" class="form-control @error('question') is-invalid @enderror" name="question" id="question" value="{{$faq->question}}">
                            @error('question')
